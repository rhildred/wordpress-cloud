...
<hr />  
	...
	<div class="gt-right">			
			<div>				
				<a href="<?php echo esc_url( ECONOMICS_LIVE_DEMO ); ?>" target="_blank"><?php esc_html_e('Live Demo', 'economics'); ?></a> | 
				<a href="<?php echo esc_url( ECONOMICS_PROTHEME_URL ); ?>"><?php esc_html_e('Purchase Pro', 'economics'); ?></a> | 
				<a href="<?php echo esc_url( ECONOMICS_THEME_DOC ); ?>" target="_blank"><?php esc_html_e('Documentation', 'economics'); ?></a>
